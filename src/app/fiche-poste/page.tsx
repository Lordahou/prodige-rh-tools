    ...
    <main className="min-h-screen bg-[#f0ebe3]">
      <header className="bg-[#081F34]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center gap-4">
          ...
          <h1 className="text-lg font-bold text-white">Fiche de poste <span className="text-[#B5E467]">IA</span></h1>
        </div>
      </header>

      <section className="bg-[#034B5C] text-white">
        <div className="max-w-6xl mx-auto px-6 py-8">
          <h2 className="text-2xl font-extrabold mb-1">Générateur de fiche de poste <span className="text-[#B5E467]">Positiv'</span></h2>
          <p className="text-white/60 text-sm">L'IA génère une offre d'emploi dans l'esprit Prodige RH — chaleureuse, humaine et engageante.</p>
        </div>
      </section>
