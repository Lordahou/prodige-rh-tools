...
const modules = [
  ...
  },
  {
    ...
    description: "Generez une offre d'emploi dans l'esprit Positiv' Recrutement de Prodige RH.",
    href: "/fiche-poste",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Collez un transcript de call client — l'IA genere un CR structure avec actions.",
    href: "/compte-rendu",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Generez une lettre de mission personnalisee et professionnelle en quelques secondes.",
    href: "/proposition",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
